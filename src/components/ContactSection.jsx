/**
 * ContactSection Component (Server)
 * Static content - no hooks needed
 */
...
export default function ContactSection() {
  return (
    <section
      id="contact"
      className="flex flex-col md:w-290 m-auto text-center mt-20 items-center gap-10 min-h-140 max-h-130 md:min-h-100"
    >
      ...
      <div className="flex md:flex-row flex-col justify-center gap-5 md:gap-10 items-center">
        ...
        <a
          href="/resume.pdf"
          download
          className="text-center px-4 w-50 py-2 border border-(--text) rounded-full 
            text-(--text) font-semibold transition-all hover:bg-(--text) hover:text-(--background)"
        >
          Download Resume
        </a>
      </div>
